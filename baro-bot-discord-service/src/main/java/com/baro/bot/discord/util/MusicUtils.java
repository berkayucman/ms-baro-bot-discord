...
//                .setUsers(message.getAuthor())
    ...
    public String getSpotifyLink(AudioPlayer player) throws Exception {
        ...
        String modifiedTitle = title
                ...
                .replace("offical", "")
                .replace(".", "");
        String url = "https://api.spotify.com/v1/search?q=" + URLEncoder.encode(modifiedTitle, "UTF-8") + "&type=track";
...
//        System.out.println(prettyJsonString);
    ...
    public Pair<Boolean, String> handleLyrics(String title) throws IOException {
        ...
        String url = "https://api.genius.com/search?q=" + URLEncoder.encode(modifiedTitle, "UTF-8");
